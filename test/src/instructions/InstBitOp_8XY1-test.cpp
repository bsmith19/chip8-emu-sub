...
class InstBitOp_8XY1Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstBitOp_8XY1Tests::SetUp()
{
    // create memory map
...
void InstBitOp_8XY1Tests::TearDown()
{
}

TEST_F(InstBitOp_8XY1Tests, handle_test)
{
    ...
    InstBitOp_8XY1* in = new InstBitOp_8XY1(0x8121);
