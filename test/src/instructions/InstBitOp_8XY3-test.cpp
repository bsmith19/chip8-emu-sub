...
class InstBitOp_8XY3Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstBitOp_8XY3Tests::SetUp()
{
    // create memory map
...
void InstBitOp_8XY3Tests::TearDown()
{
}

TEST_F(InstBitOp_8XY3Tests, handle_test)
{
    ...
    InstBitOp_8XY3* in = new InstBitOp_8XY3(0x8123);
