...
class InstSound_FX18Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstSound_FX18Tests::SetUp()
{
    // create memory map
...
void InstSound_FX18Tests::TearDown()
{
}

TEST_F(InstSound_FX18Tests, handle_test_pass)
{
}
