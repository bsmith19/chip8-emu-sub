...
class InstDisplay_00E0Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstDisplay_00E0Tests::SetUp()
{
    // create memory map
...
void InstDisplay_00E0Tests::TearDown()
{
}

TEST_F(InstDisplay_00E0Tests, handle_test_pass)
{
}
