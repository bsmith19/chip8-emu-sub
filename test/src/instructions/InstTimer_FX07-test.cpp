...
class InstTimer_FX07Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstTimer_FX07Tests::SetUp()
{
    // create memory map
...
void InstTimer_FX07Tests::TearDown()
{
}

TEST_F(InstTimer_FX07Tests, handle_test_pass)
{
}
