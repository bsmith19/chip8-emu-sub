...
class InstTimer_FX15Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstTimer_FX15Tests::SetUp()
{
    // create memory map
...
void InstTimer_FX15Tests::TearDown()
{
}

TEST_F(InstTimer_FX15Tests, handle_test_pass)
{
}
