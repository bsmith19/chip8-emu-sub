...
class InstCond_9XY0Tests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstCond_9XY0Tests::TearDown()
{
}

TEST_F(InstCond_9XY0Tests, handle_test_pass)
{
    //Setup initial register values
    mSystemData->systemCpuRegisters[0x2] = 7;
    mSystemData->systemCpuRegisters[0x1] = 8;
    
    InstCond_9XY0* in = new InstCond_9XY0(0x5120);
...
TEST_F(InstCond_9XY0Tests, handle_test_fail)
{
    //Setup initial register values
    mSystemData->systemCpuRegisters[0x2] = 7;
