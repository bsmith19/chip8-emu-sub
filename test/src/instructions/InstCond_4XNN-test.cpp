...
class InstCond_4XNNTests : public ::testing::Test
{
public:
    void SetUp();
    void TearDown();
...
void InstCond_4XNNTests::TearDown()
{
}

TEST_F(InstCond_4XNNTests, handle_test_fail)
{
    //Setup initial register values
    mSystemData->systemCpuRegisters[2] = 7;
    mSystemData->systemCpuRegisters[0x1] = 0x20;
    
    InstCond_4XNN* in = new InstCond_4XNN(0x3120);
...
TEST_F(InstCond_4XNNTests, handle_test_pass)
{
    //Setup initial register values
    mSystemData->systemCpuRegisters[2] = 7;
    mSystemData->systemCpuRegisters[0x1] = 0x20;
    
    InstCond_4XNN* in = new InstCond_4XNN(0x3122);
    EXPECT_TRUE(in->Handle(mSystemData));
